...
from Alfvenic_Auroral_Acceleration_AAA.archive.wave_fields.wave_fields_classes import WaveFieldsClasses
...
# times = [0.1*(i) for i in range(2)] # in runners seconds
times = data_dict_wavescale['time'][0] # in runners seconds
