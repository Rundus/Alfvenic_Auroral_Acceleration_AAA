...
for altitude_val in DistributionToggles.Observation_altitudes:
    ...
    if dict_executable['regen_wave_fields']==1:
        ...
        from src.Alfvenic_Auroral_Acceleration_AAA.wave_fields.wave_fields_generator_potentials import wave_fields_generator
    ...
    if dict_executable['regen_particle_distributions'] == 1:
        ...
        from src.Alfvenic_Auroral_Acceleration_AAA.distributions.distribution_generator_velspace import distribution_generator_vel
